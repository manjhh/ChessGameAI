...
class AlphaZeroChessNet(nn.Module):
    def __init__(self, board_size=8, in_channels=14, num_residual_blocks=5, filters=128):
        super(AlphaZeroChessNet, self).__init__()
        self.conv_init = nn.Conv2d(in_channels, filters, kernel_size=3, padding=1)
        ...
        self.fc_policy = nn.Linear(2 * board_size * board_size, board_size * board_size * 73)  # Ví dụ
